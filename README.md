...
Vivacity advertise themselves as a sensor and focuse on the ability of countening the behavior of road users however that is a camera that process the image on the edge and then sending the data to the customers that as away to go around the concerns of the public agains cameras. 
# Privacy and ethics of the community: 
Vivacity prioritizes privacy and data protection and claims to collect only technical data, not personal information. Their sensors are designed to anonymize data, and no video footage is recorded or streamed. The system produces anonymous data feeds that are immediately discarded. However, privacy concerns remain if individuals can be re-identified based on the technical data collected. Vivacity claims to blur faces before sharing the data and only saves 10 minutes of video from each sensor for calibration purposes. Their approach complies with GDPR, and they have implemented technical and organizational measures to ensure data security. However, the risk of data breaches and privacy violations exists, and their implementation should be monitored and evaluated.
VivaCity Limited adheres to strong ethical values, evidenced by their commitment to customer satisfaction and compliance with relevant laws and regulations. By implementing a Quality Management System (QMS) in compliance with ISO 9001:2015 standards and continuously reviewing policies and communicating them to staff and subcontractors, VivaCity Limited ensures a high level of ethical and security standards in their operations. They focus on continuous improvement and performance monitoring for their products and services, as well as for their security and privacy practices to protect customers' data(Vivacity, n.d.)  (Unknown, 2021).
...
Vivacity Labs. (2022, July). Why is VivaCity's Solution Unique? [Brochure]. Vivacity Labs. Retrieved from https://vivacitylabs.com/site/wp-content/uploads/2022/06/Why-is-VivaCitys-Solution-Unique-July-2022.pdf
